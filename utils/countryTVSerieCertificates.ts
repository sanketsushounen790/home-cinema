const countryTVSerieCertificates: CountryTVSerieCertificates = {
  NL: [
    {
      certification: "NR",
  ...
  RO: [
    ...
    },
    {
      certification: "12",
      meaning:
        "Programmes not recommended for children below the age of 12, may contain light sexual content or explicit language.",
      order: 3,
    },
    {
      certification: "15",
      meaning:
        "Programmes not recommended for teens and children below the age of 15, may contain more intensive violence and sexual content.",
      order: 4,
    },
    {
      certification: "18",
      meaning:
        "The programme is recommended for adult viewers (for ages 18 and up), may contain explicit violence and explicit sexual content.",
      order: 5,
    },
  ],
  SK: [
...
export default countryTVSerieCertificates;
