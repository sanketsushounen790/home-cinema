...
import { i18nMovieGenres, i18nMovieGenresArray } from "@/utils/genresList";
...
const sortOptions: { name: string; param_pattern: DiscoverMovieSortBy }[] = [
  {
...
const MovieDiscover = () => {
  ...
  const movieGenresArray =
    i18nMovieGenresArray[language as keyof typeof i18nMovieGenres] ||
    i18nMovieGenresArray["en"];
  ...
  const [include_video, setIncludeVideo] = useState<boolean>(false);
  ...
  const [run_time_gte, setRunTimeGte] = useState<string>("");
  const [run_time_lte, setRunTimeLte] = useState<string>("");

  const [primary_release_date_gte, setPrimaryReleaseDateGte] =
    useState<string>("");
  const [primary_release_date_lte, setPrimaryReleaseDateLte] =
    useState<string>("");
  ...
  const [sort_by, setSortBy] = useState<DiscoverMovieSortBy>("popularity.desc");
  ...
  const handleToogleBetweenMainReleaseDates = (type: string) => {
    if (type === "all") {
      ...
      setPrimaryReleaseDateGte("");
      setPrimaryReleaseDateLte("");
            ...
            >
              <div className="px-4 space-y-2">
                ...
                <select
                  ...
                  className="w-full p-2 border rounded cursor-pointer bg-base-100"
                >
          ...
          <div className="border rounded-lg bg-base-100 shadow-sm ">
            ...
            >
              <div className="px-4 space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2">
                    <label className="flex items-center gap-2 cursor-pointer">
                      ...
                      />
                      <span className="text-[15px]">Primary Release Dates</span>
                    </label>
                      ...
                      <>
                        ...
                        <div className="space-y-2">
                          <div className="flex items-center gap-2">
                            ...
                            <DateTimePicker
                              value={primary_release_date_gte}
                              onChange={setPrimaryReleaseDateGte}
                              placeholder="From"
                            />
                          </div>
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <DateTimePicker
                              value={primary_release_date_lte}
                              onChange={setPrimaryReleaseDateLte}
                              placeholder="To"
                            />
                          </div>
                        </div>
                    ...
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        ...
                        className="cursor-pointer"
                      />
                      <span className="text-[15px]">All Release Dates</span>
                    </label>
                  </div>
                          ...
                          <ul className="absolute mt-1 w-full max-h-60 overflow-y-auto bg-base-100 border rounded-lg shadow-lg z-20">
                            <li className="p-2 sticky top-0 bg-base-100">
                              <input
                                ...
                                onChange={(e) =>
                                  setSearchInDropdown(e.target.value)
                                }
                                placeholder="Search..."
                              ...
                              .filter(
                                (item) =>
                                  countryRegions[item].name
                                    .toLowerCase()
                                    .includes(searchInDropdown.toLowerCase()) ||
                                  searchInDropdown
                                    .toLowerCase()
                                    .includes(
                                      countryRegions[
                                        item
                                      ].iso_3166_1.toLowerCase()
                                    )
                              )
                              .map((region, index) => (
                                <li
                                ...
                                >
                                  ...
                                  />
                                  <span>
                                    {countryRegions[region]?.name} (
                                    {countryRegions[region]?.iso_3166_1})
                                  </span>
                                </li>
                              ))}
                          </ul>
                      ...
                      <div className="space-y-2">
                        {[1, 2, 3, 4, 5].map((item) => (
                          ...
                          >
                            <input
                              type="checkbox"
                              checked={release_type.includes(String(item))}
                              onChange={() => toggleReleaseType(String(item))}
                              className="w-4 h-4 accent-blue-500 cursor-pointer"
                            />
                            <span className="text-sm">
                              {releaseDatesType.get(item)}
                            </span>
                          </label>
                        ))}
                      </div>
                      ...
                      <ul className="absolute mt-1 w-full max-h-60 overflow-y-auto bg-base-100 border rounded-lg shadow-lg z-20">
                        ...
                        {Object.keys(countryRegions)
                          .filter((item) =>
                            ...
                            //   .toLowerCase()
                            //   .includes(
                            //     countryRegions[item].iso_3166_1.toLowerCase()
                            //   )
                            isCharsInString(
                              searchInDropdownOriginCountry,
                              countryRegions[item].name
                ...
                <div className="space-y-2">
                  <RunTimePicker
                    minRunTime={run_time_gte}
                    maxRunTime={run_time_lte}
                    onChange={(min, max) => {
                      setRunTimeGte(min);
                      setRunTimeLte(max);
                    }}
      ...
      <div className="w-[77%] p-2 ">
        {isLoading ? (
          ...
          <div className="grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] justify-center gap-6 mx-6">
            ...
            {hasNextPage && (
              <div className="w-full h-[300px] flex items-center justify-center rounded-lg bg-base-300">
                <button
