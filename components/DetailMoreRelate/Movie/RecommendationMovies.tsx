...
import { useRecommendationMovies } from "./hook/useRecommendationMovies";
    ...
    <div className="w-full h-auto mb-8">
      <div className="flex flex-wrap justify-start items-center ml-7 mt-2 mb-3 gap-3">
        <div className="font-bold text-[23px]">
          ...
          <span className="font-bold">" {decodeURI(movieName)}"</span>
        </div>
      </div>
      ...
      {isLoading ? (
        ...
        >
          ...
          {hasNextPage && movieArraylength >= 18 && (
