...
import { useDiscoverTVByNetwork } from "./hook/useDiscoverTVByNetwork";
...
interface DiscoverTVNetworkProps {
  networkName: string;
  networkId: string;
...
const DiscoverTVNetwork = ({
  ...
  networkDetail,
  type,
}: DiscoverTVNetworkProps) => {
  const { data, fetchNextPage, hasNextPage, isFetchingNextPage, isLoading } =
    useDiscoverTVByNetwork(networkId, networkName);
