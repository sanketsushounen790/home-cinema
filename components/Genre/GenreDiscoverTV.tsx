...
import { useDiscoverTVInGenre } from "./hook/useDiscoverTVInGenre";

interface GenreDiscoverTVProps {
  genreName: string;
  genreId: string;
}

const GenreDiscoverTV = ({ genreName, genreId }: GenreDiscoverTVProps) => {
  const { data, fetchNextPage, hasNextPage, isFetchingNextPage, isLoading } =
    useDiscoverTVInGenre(genreId, genreName);
  ...
  return (
    <div className="w-full h-auto mb-8">
      <div className="flex flex-wrap justify-start items-center ml-7 mt-2 mb-3 gap-3">
        <div className="font-bold text-[23px]">TV Shows with genre:</div>
...
export default GenreDiscoverTV;
