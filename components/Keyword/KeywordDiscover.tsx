...
import { useDiscoverMoviesInKeyword } from "./hook/useDiscoverMoviesInKeyword";
...
const KeywordDiscover = ({ keywordName, keywordId }: KeywordDiscoverProps) => {
  const { data, fetchNextPage, hasNextPage, isFetchingNextPage, isLoading } =
    useDiscoverMoviesInKeyword(keywordId, keywordName);
  ...
  return (
    <div className="w-full h-auto mb-8">
      <div className="flex flex-wrap justify-start items-center ml-7 mt-2 mb-3 gap-3">
        <div className="font-bold text-[23px]">Movies with keyword:</div>
...
export default KeywordDiscover;
