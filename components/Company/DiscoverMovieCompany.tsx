...
import { useDiscoverMovieByCompany } from "./hook/useDiscoverMovieByCompany";
...
interface DiscoverMovieCompanyProps {
  companyName: string;
  companyId: string;
...
const DiscoverMovieCompany = ({
  companyName,
  companyId,
  companyDetail,
  type,
}: DiscoverMovieCompanyProps) => {
  const { theme } = useThemeStore();
  const { data, fetchNextPage, hasNextPage, isFetchingNextPage, isLoading } =
    useDiscoverMovieByCompany(companyId, companyName);
...
export default DiscoverMovieCompany;
