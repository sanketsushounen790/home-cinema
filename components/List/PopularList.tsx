...
import PopularTVSerieList from "../TVSerie/PopularTVSerieList";
  ...
  return (
    ...
    >
      <div className="w-full flex items-center gap-2">
        <h2 className="text-[20px] font-semibold">Popular</h2>
      ...
      <div className="w-full flex items-center">
        {mediaType === "movie" ? <PopularMovieList /> : <PopularTVSerieList />}
      </div>
    </div>
  );
};
