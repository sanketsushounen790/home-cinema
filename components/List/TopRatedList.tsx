...
import TopRatedMovieList from "../Movie/TopRatedMovieList";
import TopRatedTVSerieList from "../TVSerie/TopRatedTVSerieList";
  ...
  return (
    ...
    >
      <div className="w-full flex items-center gap-2">
        <h2 className="text-[20px] font-semibold">Top Rated</h2>
